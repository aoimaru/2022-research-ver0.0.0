...
def do(args, target, top=20, seed="tmp"):
    ...
    # ここはパッチっぽい
    sample_cases = SampleDataVer001._patch_get_v2(run=args.sample)
    ...
    for parameter in parameters:
        ...
        try:
            ...
            while limits:
                limit = limits.pop(0)
                result = Evaluation.get_similar_objs_v2(
            ...
            for result in results[:top]:
                print(result[1])
                tokens = SampleDataVer000._patch_get_original_v2(result[0])
                words = ""
                if not tokens:
                    continue
                for token in tokens:
...
def main(args):
    ...
    do(args, target="GPG_KEY_ver0.0.1", top=20, seed="size")
    do(args, target="GPG_KEY_ver0.0.1", top=30, seed="size")
    do(args, target="GPG_KEY_ver0.0.1", top=40, seed="size")
    ...
    do(args, target="APT-GET_INSTALL_ver0.2.0", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.2.0", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.2.0", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.2.1", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.2.1", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.2.1", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.2.1", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.3.0", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.0", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.0", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.0", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.3.1", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.1", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.1", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.3.1", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.4.0", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.0", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.0", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.0", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.4.1", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.1", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.1", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.4.1", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.5.0", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.0", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.0", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.0", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.5.1", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.1", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.1", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.5.1", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.6.0", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.0", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.0", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.0", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.6.1", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.1", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.1", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.1", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.6.2", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.2", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.2", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.2", top=40, seed="size")

    do(args, target="APT-GET_INSTALL_ver0.6.3", top=10, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.3", top=20, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.3", top=30, seed="size")
    do(args, target="APT-GET_INSTALL_ver0.6.3", top=40, seed="size")

    do(args, target="APK_ADD_USE_NO_CACHE_ver0.0.0", top=10, seed="size")
    do(args, target="APK_ADD_USE_NO_CACHE_ver0.0.0", top=20, seed="size")
    do(args, target="APK_ADD_USE_NO_CACHE_ver0.0.0", top=30, seed="size")
    do(args, target="APK_ADD_USE_NO_CACHE_ver0.0.0", top=40, seed="size")
