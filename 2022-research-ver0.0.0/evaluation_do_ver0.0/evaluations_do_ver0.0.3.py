...
plt.subplot(2, 5, 1) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)
 
plt.subplot(2, 5, 2) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)

plt.subplot(2, 5, 3) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)
 
plt.subplot(2, 5, 4) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)

plt.subplot(2, 5, 5) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)

plt.subplot(2, 5, 6) # (3)グラフ描画位置の指定
draw_barchart(product_nm, sales)
